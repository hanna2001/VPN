...
width: MediaQuery.of(context).size.width,
          decoration: BoxDecoration(gradient: LinearGradient(colors: [bgOne,bgTwo],
              stops:[0.1,1],
    ...
    child: Column(
      ...
      children: [
        Container(
          ...
          children: [
            Column(children: [SizedBox(height: 130,),Image.asset("assets/rocket.png",height: 140,)],),
        ...
        Text("Come on,maximize your \n internet connection with \n us",style: styleOne,textAlign: TextAlign.center,),
        Text("We created a very cool VPN and can yur internet speed faster and safer",style: styleTwo,textAlign: TextAlign.center,),
